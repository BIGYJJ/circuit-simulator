...
export default function LEDLab() {
  ...
  return <main className="led-lab-shell">
    <header className="led-topbar"><div className="wordmark"><span>FLUX</span><strong>LAB</strong></div><div className="led-breadcrumb"><span>项目</span><i>/</i><b>LED 亮度实验</b><i>/</i><span>非线性 DC</span></div><div className="lab-mode-chip"><Zap size={14}/> 常压降近似</div><div className="led-top-actions"><Link href="/" className="compact-nav-link">RC 实验</Link><Link href="/divider" className="compact-nav-link">分压器</Link><button className="led-run" onClick={run}><Play size={16} fill="currentColor"/>运行工作点</button></div></header>
